...
function controller(target) {
	...
	this.renderCalendar = function() {
		...
		document.getElementById('calendar').innerHTML = (arrTable.join(""));
	...
	this.changeMonth = function() {
		var temp=document.getElementById('currentDate');
		temp.innerHTML = that.getYearMonth(m_oMonth).substr(0,9);
		//temp.text(that.getYearMonth(m_oMonth).substr(0,9));
...
function goPrevCalendar(){
	calendar.onPrevCalendar;
	controller.onPrevCalendar;
}